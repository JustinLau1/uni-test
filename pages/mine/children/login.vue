    ...
    <view class="login">
        <view class="content">
            ...
            <view class="main">
                ...
                <view class="footer" style="-webkit-justify-content: space-between;justify-content: space-between;">
                    <navigator url="forget" open-type="navigate">忘记密码？</navigator>
                    <!-- <text>|</text> -->
                    <text @tap="isShowAgree" class="cuIcon" :class="showAgree?'cuIcon-radiobox':'cuIcon-round'">记住密码</text>
                    <!-- <checkbox value="cb" color="#FFCC33" style="transform:scale(0.7)">记住密码</checkbox> -->
                </view>
            </view>
    ...
    export default {
        ...
        methods: {
            ...
            isLogin() {
                ...
                try {
                    ...
                    if (value) {
                        ...
                        this.phoneData = value.userCode
                        this.passData = value.userpwd
                        // uni.reLaunch({
                        // url: '../../../pages/mine/mine',
                        // });
                    }
            ...
            startLogin() {
                ...
                setTimeout(function() {
                    _this.$api.login({
                        userCode: _this.phoneData,
                        userPassword: md5(_this.passData),
                        // userCode: "glgc",
                        // // userCode: "hpgg",
                        ...
                        // let userdata = {
                        //     "userCode": showAgree ? res.data.data.newUserCode : "",
                        //     "userpwd": showAgree ? this.passData : ""
